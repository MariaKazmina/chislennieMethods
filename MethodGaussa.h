...
void methodG(long double* a, long double* b, long double* c, long double* d, long double* e, long double* f1, long double* f2, long double* c1, long double* c2, int n); //непосредственно метод Гаусса
